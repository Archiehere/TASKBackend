...
const sendmail = async (email,otp) => {
    const msg = {
        from: 'TASKBackend"spaces.inc.si@gmail.com"',
        to: email,
        subject: `${otp} is your OTP from TASKBackend`,
        html: `
        <div
          class="container"
          style="max-width: 90%; margin: auto; padding-top: 20px"
        >
          <center><h2>Welcome to <span style="color:green;">TASKBackend</span></h2></center>
